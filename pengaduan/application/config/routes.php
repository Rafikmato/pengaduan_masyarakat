...
$route['/pengguna/surat'] = 'Surat/index';
$route['/pengguna/persyaratan'] = 'Persyaratan/index';
$route['/admin/crd_persyaratan'] = 'admin/Crd_Persyaratan/index/$1';
$route['/admin/crd_persyaratan/tambah_persyaratan'] = 'admin/Crd_Persyaratan/tambah_persyaratan';
