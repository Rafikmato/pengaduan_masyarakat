...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
	<a class="navbar-brand" href="">KONSUL-HUB</a>
				...
				<?php if ($this->session->userdata('admin')) {  ?>
					<div class="nav">
						...
						<!-- <a class="nav-link" href="<?= base_url('admin/persyaratan') ?>">
							<div class="bi bi-envelope-arrow-down-fill "><i class=""></i></div>
							 Persyaratan
						</a> -->
						...
						<?php if ($this->session->userdata('admin')['session_level'] == "admin") { ?>
							...
							<a class="nav-link" href="<?= base_url('admin/crd_persyaratan') ?>">
								<div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
								Persyaratan
							</a>
					...
					<div class="nav">
						...
						<a class="nav-link" href="<?= base_url('admin/persyaratan') ?>">
							<div class="d-flex align-items-center">
								<div class="bi bi-envelope-arrow-down-fill me-2"> </div>
						...
						<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="<?= base_url('pengaduan') ?>">Data Konsultasi</a>
								<a class="nav-link" href="<?= base_url('pengaduan/tambah') ?>">Tambah Konsultasi</a>
							</nav>
						</div>
					</div>
				<?php  } ?>
