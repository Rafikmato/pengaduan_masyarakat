...
<style>
	.card {
    background-color: rgba(255, 255, 255, 0.5); /* Nilai alpha yang lebih rendah membuatnya lebih transparan */
}
						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">Nama Aplikasi</h3>
									<h6 class = "text-center">Dinas Kependudukan Dan Pencatatan Sipil <br> Kota Gorontalo</h4>
								</div>
