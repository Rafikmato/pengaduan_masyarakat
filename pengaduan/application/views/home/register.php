...
<head>
	...
	<title>Daftar - Sistem Konsultasi Masyarakat</title>
							...
							<div class="card-body">
								<form action="" method="post">
									...
									<div class="form-group"><label class="small mb-1" for="Username">Username</label>
										<input class="form-control py-4" id="Username" type="text" aria-describedby="emailHelp" placeholder="Masukan username" name="username" />
									</div>
									<div class="form-group">
									...
									<div class="form-row">
										...
										<div class="col-md-6">
											<div class="form-group"><label class="small mb-1" for="inputConfirmPassword">Konfirmasi Password</label><input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Masukan kembali password" name="confirm_password" />
											</div>
										</div>
									</div>
									<div class="form-group">
	...
	<div id="layoutAuthentication_footer">
		<footer class="py-4 bg-light mt-auto">
			<div class="container-fluid">
				...
				<div class="text-muted">Copyright &copy; Informatika UNG | Repost by Teknik Informatika </a></div>
					<div>
